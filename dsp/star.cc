...
*/
    ...
    auto num9 = maths::lerp(-0.98f, 0.88f, star->level);
...
/*
    star->color = maths::clamp01(((float)num13 + 3.5f) * 0.2f);
        ...
        for (auto i = 0; i < planetCount; i++) {
            ...
            if (num16 == 0) {
                ...
                while (true) {
                    ...
                    a = num17 <= 3 ? maths::lerp(a, 1.0f, 0.15f) + 0.01f : maths::lerp(a, 1.0f, 0.45f) + 0.01f;
